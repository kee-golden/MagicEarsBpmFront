/* eslint-disable no-var,func-names,camelcase,camelcase,padded-blocks,max-len,no-shadow,vars-on-top,no-use-before-define,no-mixed-operators,eqeqeq,block-scoped-var,no-redeclare,default-case,no-case-declarations,no-inner-declarations,new-cap,no-undef,one-var,no-lonely-if,brace-style,no-restricted-properties,no-caller,indent,prefer-arrow-callback */
/* -----------------------------------------------
